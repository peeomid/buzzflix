"""
Django settings for Buzzflix project.
...
SECRET_KEY = 'q)^apx1rf$)exemlk=x0)g8s$3e=$auv(2hi6u93k^%6ic_--z'
...
WSGI_APPLICATION = 'Buzzflix.wsgi.application'
